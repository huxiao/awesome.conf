--[[
     ...
     Hugo's Awesome WM configuration file : rc.lua
...
-- {{{ Wallpaper
--beautiful.wallpaper="/home/huxiao/Pictures/wallpapers/8_ive_völker_-_staffelsee.jpg"
...
run_once("goldendict")
run_once("~/.nutstore/bin/nutstore-pydaemon.py")
